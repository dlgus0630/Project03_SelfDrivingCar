...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, TRIG_LEFT_Pin|TRIG_FRONT_Pin|TRIG_RIGHT_Pin|BUZZER_Pin
  ...
  /*Configure GPIO pins : TRIG_LEFT_Pin TRIG_FRONT_Pin TRIG_RIGHT_Pin BUZZER_Pin
                           LED_STATUS_Pin */
  GPIO_InitStruct.Pin = TRIG_LEFT_Pin|TRIG_FRONT_Pin|TRIG_RIGHT_Pin|BUZZER_Pin
                          |LED_STATUS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
